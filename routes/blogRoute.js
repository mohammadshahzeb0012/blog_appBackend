...
const { creatBlogController, allBlogsController, myblogsController, editBlogController, likeBlogController, commnetBlogController, deleteBlogController } = require("../controllers/blogController")
const blogRouter = express.Router()

blogRouter.post("/createBlog",iaAuth,creatBlogController)
blogRouter.post("/editBlog",iaAuth,editBlogController)
blogRouter.post("/delete",iaAuth,deleteBlogController)
